...
\lineref{McSplitSIAlg} the \emph{variable ordering heuristic}, and the
...
presented by McCreesh et al.\ \cite{DBLP:journals/jair/McCreeshPST18}.  The results
showed similar patterns to those shown here for \McSplit-SI.)
...
(density) parameter ranging from 0 to 1.  The plot shows, for each pair of density
...
10 times the search effort of the best strategy.

TODO talk about what we see... complicated patterns, looks like diagonal, then looks
like horizontal line... what heuristics should we conclude that we should use?

\cref{figure:sip-heatmaps}

\begin{figure}[htb]
    \centering
    \subfigure[][Pattern order 8] {
        \centering
        \includegraphics*[width=0.85\textwidth]{14b-mcsplit-induced-si/deg_sorting_experiment_fine_grained/img/heatmap_sip8.pdf}
        \label{figure:sip-heatmap-8}
    }
    \subfigure[][Pattern order 12] {
        \centering
        \includegraphics*[width=0.85\textwidth]{14b-mcsplit-induced-si/deg_sorting_experiment_fine_grained/img/heatmap_sip12.pdf}
        \label{figure:sip-heatmap-12}
    }
    \subfigure[][Pattern order 16] {
        \centering
        \includegraphics*[width=0.85\textwidth]{14b-mcsplit-induced-si/deg_sorting_experiment_fine_grained/img/heatmap_sip16.pdf}
    ...
    \caption{Heatmaps of search effort compared to the best strategy, varying pattern and target density}\label{figure:sip-heatmaps}
\end{figure}

TODO: say that choosing a rule based on target density is somehow the same as choosing
based on variable deg?

TODO Talk about RI's static heuristic.  Advantages include speed (no need to compute
at each search node)
