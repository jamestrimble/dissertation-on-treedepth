...
\begin{itemize}
    ...
    \item \textbf{PR:} Instances derived from a pattern recognition problem, where
    	the graphs are generated from the adjacencies of regions of an image. \citep{DBLP:journals/pr/SolnonDHJ15}
    ...
    \item \textbf{Meshes} and \textbf{Images:} TODO
\end{itemize}
