...
\McSplit-SI explores the same search tree as \McSplit. Its key differences from
\McSplit\ are the use of adjacency lists rather than adjacency matrices
to represent graphs; a backtrackable, doubly-linked list of label class objects;
and algorithms for partitioning and un-partitioning that are more intricate
...
\Cref{sec:mcsplit-si-space-complexity} shows that the algorithm is space-efficient.
...
\begin{figure}[htb]
    ...
    \caption{The data structures of \McSplit-SI after assigning vertex $1$ to vertex $a$.
        ...
        show the arrays $\Gptrs$ and $\Hptrs$.  Each element of these arrays
...
complex way.
In the experimental evaluation in \Cref{sec:si-experiments}, I consider two 
...
TODO talk about \Cref{tab:si-decision-winner-counts}
