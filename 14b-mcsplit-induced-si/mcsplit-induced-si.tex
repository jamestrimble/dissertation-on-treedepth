...
\Cref{sec:mcsplit-si-adjmat} introduces another alternative version that is
well-suited to dense graphs.
\Cref{sec:mcsplit-si-gac} shows that \McSplit-SI achieves generalised arc consistency
...
contiguously in an array (the LC-array), and each object representing a label class $\langle
...
\footnotesize
 ...
 \midrule
    ...
    \rule{0pt}{2.3ex}\varStartG & Pointer to Integer & Pointer to the first vertex of set $S_G$\\
    \rule{0pt}{2.3ex}\varEndG & Pointer to Integer & Pointer to one element past the last vertex of set $S_G$\\
    \rule{0pt}{2.3ex}\varStartH & Pointer to Integer & Pointer to the first vertex of set $S_H$\\
    \rule{0pt}{2.3ex}\varEndH & Pointer to Integer & Pointer to one element past the last vertex of set $S_H$\\
...
Within this loop are two pairs of functions:
...
does this by swapping $v$ and $w$ to the end of their label class in
...
creating new label classes as required (\Cref{McSplitSIAlgCreateLC}).
...
Our variable ordering heuristic is \emph{smallest domain first},
...
\begin{figure}[htb]
    ...
    \caption{Heatmaps of \McSplit-SI search effort compared to the best strategy, varying pattern density
...
using opposite orders for the pattern and target graphs is only of benefit in small
...
|S_H|)$ time and
\DIFdel{$|S_H|$ words of additional space;}
\DIFadd{sufficient space to store the indices of $|S_H|$ vertices;}
the second requires
...
in \Cref{sec:si-experiments} shows that \McSplit-SI-LL and \McSplit-SI have broadly
...
\section{\McSplit-SI-AM: A Version for Dense Graphs}\label{sec:mcsplit-si-adjmat}
...
dense graphs.  The main additional feature compared to the maximum
...
The Glasgow Subgraph Solver \citep{DBLP:conf/cp/McCreeshP15} introduces a new propagation algorithm,
...
\begin{figure}[htb]
    ...
    \subfigure[][$G_2$] {
        \centering
        \scalebox{1}{
          \begin{tikzpicture}[scale=0.95, every node/.style={scale=0.8,shape=circle,inner sep=.5pt,
                  minimum size=7.2mm}]
              \node[draw] (u) at (0,1) {$u$};
...
experiment was run did not handle disconnected graphs correctly.}
...
With supplemental graphs \DIFadd{(see Section} \ref{subsec:cp-sip}\DIFadd{)} disabled,
the Glasgow algorithm suffers from the same problem.
...
\begin{itemize}
    ...
    \item \textbf{Phase:} Pairs of Erd\H{o}s-Rényi $G(n,p)$ random graphs
        ...
        to make the instances very challenging despite having only 30 vertices
...
\Cref{figure:isip-decision-instances-cumulative} shows cumulative plots of instances solved by \McSplit-SI
...
\begin{figure}[htb]
    \centering
    \subfigure[][Glasgow] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/cumulative-mcsplit-glasgow}
    }\subfigure[][Glasgow, no supp.] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/cumulative-mcsplit-glasgow-nosupp}
    }\subfigure[][RI] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/cumulative-mcsplit-ri}
    }\subfigure[][RI-DS] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/cumulative-mcsplit-ri-ds}
    }
    \subfigure[][VF3] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/cumulative-mcsplit-vf3}
    }
    \subfigure[][\McSplit-SI-LL] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/cumulative-mcsplit-si-ll}
    }
    \subfigure[][\McSplit-SI-AM] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/cumulative-mcsplit-si-am}
    }
    ...
    \label{figure:isip-decision-instances-cumulative}
\end{figure}
...
\begin{figure}[htb]
    \centering
    \subfigure[][Glasgow] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/scatter-mcsplit-glasgow-jittered}
    }\subfigure[][Glasgow, no supp.] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/scatter-mcsplit-glasgow-nosupp-jittered}
    }\subfigure[][RI] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/scatter-mcsplit-ri-jittered}
    }\subfigure[][RI-DS] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/scatter-mcsplit-ri-ds-jittered}
    }
    \subfigure[][VF3] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/scatter-mcsplit-vf3-jittered}
    }
    \subfigure[][\McSplit-SI-LL] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/scatter-mcsplit-si-ll-jittered}
    }
    \subfigure[][\McSplit-SI-AM] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/scatter-mcsplit-si-am-jittered}
    }
...
\begin{figure}[htb]
    \centering
    \subfigure[][Scalefree] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/by-family/scatter-Scalefree-jittered}
    }
    \subfigure[][LV] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/by-family/scatter-LV-jittered}
    }
    \subfigure[][BVG] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/by-family/scatter-BVG-jittered}
    }

    \subfigure[][M4D] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/by-family/scatter-M4D-jittered}
    }
    \subfigure[][Rand] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/by-family/scatter-Rand-jittered}
    }
    \subfigure[][PR] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/by-family/scatter-PR-jittered}
    }

    \subfigure[][Phase] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/by-family/scatter-Phase-jittered}
    }
    \subfigure[][Meshes] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/by-family/scatter-Meshes-jittered}
    }
    \subfigure[][Images] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/by-family/scatter-Images-jittered}
    }
...
\begin{figure}[htb]
    \centering
    \subfigure[][Scalefree] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/by-family/scatter-Scalefree-vbos-jittered}
    }
    \subfigure[][LV] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/by-family/scatter-LV-vbos-jittered}
    }
    \subfigure[][BVG] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/by-family/scatter-BVG-vbos-jittered}
    }

    \subfigure[][M4D] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/by-family/scatter-M4D-vbos-jittered}
    }
    \subfigure[][Rand] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/by-family/scatter-Rand-vbos-jittered}
    }
    \subfigure[][PR] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/by-family/scatter-PR-vbos-jittered}
    }

    \subfigure[][Phase] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/by-family/scatter-Phase-vbos-jittered}
    }
    \subfigure[][Meshes] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/by-family/scatter-Meshes-vbos-jittered}
    }
    \subfigure[][Images] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/by-family/scatter-Images-vbos-jittered}
    }
...
\Cref{figure:presolve-scatter} compares the run times of
\McSplit-SI-static + \McSplit-SI presolve ($x$ axis) with those of
seven other algorithms ($y$ axes) on an instance-by-instance basis.
Unlike in \Cref{figure:si-decision-scatter}, which did not use presolve,
we see few hard instances where Glasgow is much faster than the presolve version
of \McSplit-SI, and almost no hard instances where a pattern recognition
solver (RI, RI-DS or VF3) is faster
than the presolve version of \McSplit-SI.

\begin{figure}[htb]
    \centering
    \subfigure[][Glasgow] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/scatter-presolve-mcsplit-glasgow-jittered}
    }\subfigure[][Glasgow, no supp.] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/scatter-presolve-mcsplit-glasgow-nosupp-jittered}
    }\subfigure[][RI] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/scatter-presolve-mcsplit-ri-jittered}
    }\subfigure[][RI-DS] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/scatter-presolve-mcsplit-ri-ds-jittered}
    }
    \subfigure[][VF3] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/scatter-presolve-mcsplit-vf3-jittered}
    }
    \subfigure[][\McSplit-SI-LL] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/scatter-presolve-mcsplit-si-ll-jittered}
    }
    \subfigure[][\McSplit-SI-AM] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/decision-instances-experiment/experiment/plots/scatter-presolve-mcsplit-si-am-jittered}
    }
    \caption{Scatter plots of run times in ms for decision instances.
...
\DIFadd{Moving beyond the figures shown in} \Cref{tab:si-decision-solved-counts},
\DIFadd{if we exclude the easiest instances---those that both \McSplit-SI
and Glasgow can solve in less than one second---the relative standings of the
best solvers are unaffected.  Of the 753 instances that are challenging
by this measure, \McSplit-SI, Glasgow, and the presolve version of \McSplit-SI
can solve 641, 656, and 678 instances respectively within the time limit
of 1000 seconds.}
...
\caption{For each family of instances, the number of instances for which each solver's
    ...
    are the best (or joint-best) for that family.}
...
on the $y$ axis; a ratio below 1 indicates that \McSplit-SI is the faster solver.\footnote{This
analysis was carried out using target graph density because we would expect the target graph to have
...
Trivial instances and instances where at least one
...
\DIFadd{If both graphs are without edge labels (which is the case for all benchmark
instances used in this section), the set of induced subgraph isomorphisms from pattern graph $G$
to target graph $H$ is unchanged if we use the complements of both $G$ and $H$ rather than the original
graphs.  If the graphs are very dense, it may therefore be beneficial to take complements of both
input graphs and then use \McSplit-SI to solve the problem on the resulting sparse
graphs.}\footnote{\DIFadd{The author thanks Jessica Enright for this observation.}}
\DIFadd{For the current set of benchmark instances, this approach is likely to be of limited use, as fewer
than 1\% of the instances have target graphs with density greater than 0.9.}

\paragraph*{Discussion} \DIFadd{We have seen in this section that \McSplit-SI performs favourably
in comparison to exising solvers, particularly on easy instances and instances with very sparse
graphs.  For harder instances (say, those that cannot be solved in less than 1 seconds by
any of the used solvers), \McSplit-SI does not dominate, but it remains competitive with
Glasgow, the leading existing solver.  In particular, a version of \McSplit-SI with a presolve
step solves more instances within 1000 seconds than does Glasgow.}

\DIFadd{A limitation of the benchmark instances that we have used is that most
instances are trivial for the best solvers. The results of our experiments
therefore do not give a clear picture of how the solvers compare as instances
become very challenging.  \McSplit-SI can solve
more than 14,100 of the 14,621 instances with a 1 second time limit per instance,
and Glasgow can solve almost 14,000 with the same time limit.  It would be useful
future work
to create a large set of more challenging instances and perhaps use a longer time
limit to better compare the solvers.}
...
the set of instances with pairs of sparser graphs.
...
\Cref{figure:labelled-vf-instance-runtimes} shows run times for instances with labelled vertices.
...
We have so far seen sparse and dense variants of \McSplit\ for induced subgraph isomorphism
(\McSplit-SI and \McSplit-SI-AM), and
a dense variant for maximum common induced subgraph (the \McSplit
algorithm of \Cref{c:mcsplit-i-undirected}).  The algorithm that is missing from this
...
is replaced by a sequence of calls, one for each goal value of the
...
we use the 14,621 subgraph isomorphism instances described in
...
common induced subgraph solvers.
...
of run times by family, comparing the best two algorithms.
Points
above the diagonal line represent instances for which \McSplit-sparse
is faster than \kDown+SBS; on all families except Phase and Meshes,
many more points lie above the line than below it. (The
Phase instances, all of which are unsatisfiable for the subgraph
isomorphism problem, are very challenging for maximum common subgraph solvers.
No solver could solve any of these instances within the time limit.)

Looking at the number of instances that were solved within the 1000 second time limit,
\McSplit-sparse is the clear winner on the Images family,
solving 242 more Images instances
within the time limit than \kDown+SBS.
...
\begin{figure}[htb]
    \centering
    \subfigure[][Scalefree] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/sip-instances-mcis-experiment/experiment/plots/by-family/scatter-Scalefree-jittered}
    }
    \subfigure[][LV] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/sip-instances-mcis-experiment/experiment/plots/by-family/scatter-LV-jittered}
    }
    \subfigure[][BVG] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/sip-instances-mcis-experiment/experiment/plots/by-family/scatter-BVG-jittered}
    }

    \subfigure[][M4D] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/sip-instances-mcis-experiment/experiment/plots/by-family/scatter-M4D-jittered}
    }
    \subfigure[][Rand] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/sip-instances-mcis-experiment/experiment/plots/by-family/scatter-Rand-jittered}
    }
    \subfigure[][PR] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/sip-instances-mcis-experiment/experiment/plots/by-family/scatter-PR-jittered}
    }

    \subfigure[][Phase] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/sip-instances-mcis-experiment/experiment/plots/by-family/scatter-Phase-jittered}
    }
    \subfigure[][Meshes] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/sip-instances-mcis-experiment/experiment/plots/by-family/scatter-Meshes-jittered}
    }
    \subfigure[][Images] {
        \includegraphics*[width=0.24\textwidth]{14b-mcsplit-induced-si/sip-instances-mcis-experiment/experiment/plots/by-family/scatter-Images-jittered}
    }
...
on a cumulative plot can be
highly dependent on the composition of the set of
