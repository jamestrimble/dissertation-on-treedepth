...
on two sets of benchmark instances.  For the first set of instances, we solve the problem
of whether there exists an induced subgraph isomorphism from the pattern graph to the target
...
\subsection{Satisfiability instances}

\subsection{Enumeration instances}

Our second set of benchmark instances
