...
\centering
\footnotesize
    \begin{tabular}{p{0.2\linewidth} p{0.1\textwidth} p{0.1\linewidth} p{0.25\linewidth} p{0.2\linewidth} p{0.2\linewidth}}
 \toprule
     Family & Description & Count & Target $n$ & Target density & Source\\ [0.5ex]
 \midrule
     1 & \cite{DBLP:books/daglib/0012457} & y & z & w & \citet{DBLP:journals/constraints/ZampelliDS10} \\
     \rule{0pt}{2.3ex}2 & x & y & z & w & v \\
 \bottomrule
\end{tabular}
