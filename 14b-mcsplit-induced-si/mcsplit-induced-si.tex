...
Our second set of instances 

\begin{figure}[htb]
    \centering
    \subfigure[][TODO] {
        \centering
        \includegraphics*[width=0.45\textwidth]{14b-mcsplit-induced-si/knight-grid-experiment/img/p2-p24.pdf}
        \label{figure:TODO}
    }
    \subfigure[][TODO] {
        \centering
        \includegraphics*[width=0.45\textwidth]{14b-mcsplit-induced-si/knight-grid-experiment/img/12-by-12-p2-p24.pdf}
        \label{figure:TODO}
    }
    \caption{TODO}\label{figure:knights-example}
\end{figure}
