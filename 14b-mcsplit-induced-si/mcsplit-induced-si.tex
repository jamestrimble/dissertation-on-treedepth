...
\Lineref{McSplitSIReturnTrue} returns \boolT\ if a mapping containing all
...
\Cref{mcsplit-si-heuristics}.) We then iterate over the vertices $w$ in $S_H$,
...
class object so we can store the $\AlgVar{deletions}$ list as a linked list
