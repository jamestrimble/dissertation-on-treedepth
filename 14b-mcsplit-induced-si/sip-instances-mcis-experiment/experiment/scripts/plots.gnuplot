...
plot "fatanode-results/runtimes.txt" u 2:($2>=1e6?1e-10:1) smooth cumulative w l ti '\textproc{McSplit}-sparse' lc 1, \
     "fatanode-results/runtimes.txt" u 4:($4>=1e6?1e-10:1) smooth cumulative w l ti '$k\downarrow$' lc 3, \
     "fatanode-results/runtimes.txt" u 5:($5>=1e6?1e-10:1) smooth cumulative w l ti '$k\downarrow$+SBS' lc 4
...
plot "fatanode-results/runtimes-with-family-scaling.txt" u 2:($2>=1e6?1e-10:$6) smooth cumulative w l ti '\textproc{McSplit}-sparse' lc 1, \
     "fatanode-results/runtimes-with-family-scaling.txt" u 4:($4>=1e6?1e-10:$6) smooth cumulative w l ti '$k\downarrow$' lc 3, \
     "fatanode-results/runtimes-with-family-scaling.txt" u 5:($5>=1e6?1e-10:$6) smooth cumulative w l ti '$k\downarrow$+SBS' lc 4
