...
plot \
    ...
    "../experiments/gpgnode-results/mcs33ve-connected/runtimes.data" u 4:($4>=1e6?1e-10:1) smooth cumulative w l notitle lc 7
...
plot \
    "../experiments/gpgnode-results/mcs33ve-connected/runtimes.data" u 2:($2>=1e6?1e-10:1) smooth cumulative w l ti '\raisebox{1.2mm}{clique}' at end lc 3, \
    ...
    "../experiments/gpgnode-results/mcs33ve-connected/runtimes.data" u 4:($4>=1e6?1e-10:1) smooth cumulative w l ti '\raisebox{-1mm}{\textproc{McSplit}${\downarrow}$}' at end lc 7
