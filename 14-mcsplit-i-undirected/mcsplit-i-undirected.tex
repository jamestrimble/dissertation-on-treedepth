...
\begin{figure}[htb]
    ...
    \subfigure[][Unlabelled, undirected, not connected] {
        \centering
        \includegraphics*{14-mcsplit-i-undirected/img/gen-graph-plain-cumulative.pdf}
        \label{figure:plain-cumulative}
    }

    \subfigure[][Vertex and edge labelled, directed, not connected] {
        \centering
        \includegraphics*{14-mcsplit-i-undirected/img/gen-graph-33ved-cumulative.pdf}
        \label{figure:33ved-cumulative}
    }

    \subfigure[][Unlabelled, undirected, connected] {
        \centering
        \includegraphics*{14-mcsplit-i-undirected/img/gen-graph-plain-connected-cumulative.pdf}
        \label{figure:plain-connected-cumulative}
    }

    \subfigure[][Vertex and edge labelled, undirected, connected] {
        \centering
        \includegraphics*{14-mcsplit-i-undirected/img/gen-graph-33ve-connected-cumulative.pdf}
...
\begin{figure}[htb]
    \centering
    \includegraphics*[width=0.6\textwidth]{14-mcsplit-i-undirected/img/gen-graph-sip-cumulative.pdf}
