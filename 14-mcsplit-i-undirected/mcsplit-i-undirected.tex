...
number of instances, \McSplit\ and \McSplitDown\ are both more than an order of magnitude
faster than each of the other algorithms.
...
solved; this is shown by the colour of the points.
