...
\nl \For {$x \in S$ \label{CliqueWLoop}} {
    \nl    \lIf {$\FuncSty{CliqueSearch}(P \cap N(x), C \cup \{x\}, t)$}{\KwSty{return $\AlgVar{true}$\label{CliqueFirstSearch}}}
     }
    \nl  \lIf {$\FuncSty{CliqueSearch}(P \setminus S, C, t)$}{\KwSty{return $\AlgVar{true}$\label{CliqueSecondSearch}}}
