...
Why is this? We do not see a similar correlation between the search tree size
of \McSplit\
...
best solver.  Finally, Dilkas a constructs hybrid algorithm, \textsc{Fusion}, that switches
