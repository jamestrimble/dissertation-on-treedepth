...
cat mcs33vedinstances.txt | while read instance rest; do
    echo $(
        echo $instance
        show_cp2016_time_or_timeout program-output-ved/$instance.cp2016.txt
        show_time_or_timeout program-output-ved/$instance.incmc2.txt
        show_time_or_timeout program-output-ved/$instance.incmc2o1.txt
        show_time_or_timeout program-output-ved/$instance.incmc2o2.txt
    )
done
