...
cat mcsplaininstances.txt | while read instance rest; do
    echo $(
        echo $instance
        show_cp2016_optimum_or_timeout program-output-plain/$instance.cp2016.txt
        show_optimum_or_timeout program-output-plain/$instance.incmc2.txt
        show_optimum_or_timeout program-output-plain/$instance.incmc2o1.txt
        show_optimum_or_timeout program-output-plain/$instance.incmc2o2.txt
    )
done
