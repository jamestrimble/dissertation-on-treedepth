...
public class MaxClique {
	...
	readDIMACS(args[1]);
	MC mc = null;
	if (args[0].equals("MC1"))              mc = new MC(n,A,degree,1);
	else if (args[0].equals("MC2"))         mc = new MC(n,A,degree,2);
	else if (args[0].equals("MC3"))         mc = new MC(n,A,degree,3);
	else if (args[0].equals("MC0"))         mc = new MC0(n,A,degree,1);
	...
	else if (args[0].equals("Cliquer1"))    mc = new Cliquer(n,A,degree,1);
	else if (args[0].equals("Cliquer2"))    mc = new Cliquer(n,A,degree,2);
	else if (args[0].equals("Cliquer3"))    mc = new Cliquer(n,A,degree,3);
	else if (args[0].equals("Cliquer-1"))    mc = new Cliquer(n,A,degree,-1);
	else if (args[0].equals("Cliquer-2"))    mc = new Cliquer(n,A,degree,-2);
	else if (args[0].equals("Cliquer-3"))    mc = new Cliquer(n,A,degree,-3);
	else if (args[0].equals("MCSCliquer1")) mc = new MCSCliquer(n,A,degree,1);
	else if (args[0].equals("MCSCliquer2")) mc = new MCSCliquer(n,A,degree,2);
	else if (args[0].equals("MCSCliquer3")) mc = new MCSCliquer(n,A,degree,3);
	else return;

	System.gc();
	if (args.length > 2) mc.timeLimit = 1000 * (long)Integer.parseInt(args[2]);
	//mc.trace = args.length > 3;
