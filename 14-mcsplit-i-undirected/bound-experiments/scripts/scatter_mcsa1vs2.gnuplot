...
set output "plots/bounds-mcsa1vs2-plot.tex"
#set terminal png
...
plot \
    "results_pivoted_mcsa1_2.tsv" u 2:7 pt 7 lc rgb "#991f77b4" ps .3 notitle, \
    "results_summary_mcsa1_2.tsv" using ($1-.3):2:(.6):(0) with vectors nohead lw 2 lc rgb "#000000" notitle
