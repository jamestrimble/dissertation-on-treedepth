...
Thus an induced subgraph of directed graph $D = (V, A)$ is a directed graph
...
adjacency list representation, list $v$ contains those vertices $w$ such
...
\DIFadd{``yes''---if the instance is \emph{satisfiable}---we} can give a proof
...
\DIFadd{The repository for at \url{https://github.com/jamestrimble/phd-thesis}
contains a README file with links to implementations of all the new algorithms
