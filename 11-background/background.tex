...
The \textsc{Clique} problem (to determine whether a given graph graph contains
a $k$-vertex clique) is \NP-hard \citep{DBLP:conf/coco/Karp72}, and each
of our three problems can be seen to be \NP-hard by a simple reduction from
\textsc{Clique}.
