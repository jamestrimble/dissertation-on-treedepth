...
\citep{DBLP:conf/cp/McCreeshP15}, while others use it to refer to induced
...
The primary experimental setup used for this dissertation was cluster
of machines with dual Intel Xeon E5-2697A v4 CPUs with thermal scaling disabled
and 512GBytes RAM. All algorithms used are sequential; 32 instances
...
authors were implemented either in C or C++.  In all cases, the 
