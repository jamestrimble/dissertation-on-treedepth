...

{
    ...
    Before beginning the algorithm, we use Nauty \cite{DBLP:journals/jsc/McKayP14} to compute the orbits
    ...
    \begin{figure}[htb]
      ...
      \scalebox{1.2}{
        \begin{tikzpicture}[scale=0.95, every node/.style={scale=0.95}]
            \node[shape=circle,draw=black,inner sep=1.8pt] (1) at (0,0) {1};
            \node[shape=circle,draw=black,inner sep=1.8pt] (2) at (1,0) {2};
            \node[shape=circle,draw=black,inner sep=1.8pt] (3) at (2,0) {3};
            \node[shape=circle,draw=black,inner sep=1.8pt] (4) at (3,0) {4};
            \node[shape=circle,draw=black,inner sep=1.8pt] (5) at (.5,0.7) {5};
            \node[shape=circle,draw=black,inner sep=1.8pt] (6) at (2.5,0.7) {6};
            \node[shape=circle,draw=black,inner sep=1.8pt] (7) at (1.5,1.4) {7};
