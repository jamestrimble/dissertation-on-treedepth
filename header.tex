\documentclass[twoside,hidelinks,nogutter]{glasgowthesis}
...
\newcommand*\treenode[1]{\tikz[baseline=(char.base)]{
        \node[shape=circle,draw,inner sep=1.7pt] (char) {\footnotesize #1};}}
...
\newcommand{\PolyTime}{\ensuremath{\mathsf{P}}}

\newcommand{\AlgorithmFontSize}{\footnotesize}
\newcommand{\AlgorithmFontSizeB}{\small}
...
%%% For corrections: something like latexdiff, but by hand :-)
%%% To show the diff, uncomment the line that says \newcommand*{\SHOWDIFF}{}
\newcommand*{\SHOWDIFF}{}
\ifdefined\SHOWDIFF
    \RequirePackage[normalem]{ulem} %DIF PREAMBLE
    \RequirePackage{color}\definecolor{RED}{rgb}{1,0,0}\definecolor{BLUE}{rgb}{0,0,1} %DIF PREAMBLE
    \providecommand{\DIFadd}[1]{{\protect\color{blue}\uwave{(ADDED) #1}}} %DIF PREAMBLE
    \providecommand{\DIFdel}[1]{{\protect\color{red}\sout{(DELETED) #1}}}                      %DIF PREAMBLE
\else
