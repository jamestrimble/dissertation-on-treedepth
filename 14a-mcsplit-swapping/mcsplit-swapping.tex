...
\chaptermark{Swapping Graphs and Two-Sided Branching}
...
\Cref{sec:mcis-instances}; we will refer to these as the MCS Plain
instances.  As with all experiments in this chapter, the \DIFdel{plot} \DIFadd{plots} use a
...
\Lineref{ChooseBranchingSideMS2} chooses which side of
the label class $\langle \setG, \setH\rangle$ to branch on.
If $S_G$ is no larger than $S_H$,
...
on all four instance families shown in \Cref{figure:mcsplit2-cumulative}.
