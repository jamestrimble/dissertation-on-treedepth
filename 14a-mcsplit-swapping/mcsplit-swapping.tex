...
shows run times for the MCS Plain instances described in \Cref{sec:mcsplit-experiments}.
...
show this algorithm, \McSplit-2S (with the name signifying ``2 sided''), in \Cref{McSplit-2SAlg}.
...
$|G| \leq |H|$ on \Cref{ChooseBranchingSideMS2} with $|G| > |H|$.  We call this \McSplit-2S'.
