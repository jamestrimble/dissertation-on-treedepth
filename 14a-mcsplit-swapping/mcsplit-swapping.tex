...
Our experimental evaluation finds that algorithm improves upon \McSplit,
albeit very modestly, for some classes of graphs.
...
generated two sets of random instances using the Erdos-Renyi $G(n,p)$ model.
...
in run times are very marginal.  TODO: UPDATE NUMBERS, TALK ABOUT TIMOUT WEIRDNESS
