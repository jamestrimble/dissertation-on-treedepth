...
\paragraph*{\ChapterRef{c:background}} \hspace{-.8em} provides context for this dissertation's
contributions: definitions, a survey of related work, and a description of the
experimental setup.

\paragraph*{\ChapterRef{c:mcsplit-i-undirected}} \hspace{-.8em} introduces the \McSplit\
...
\paragraph*{\ChapterRef{c:swapping-graphs-mcsplit}} \hspace{-.8em} asks whether and when it is
...
\paragraph*{\ChapterRef{c:mcsplit-si}} \hspace{-.8em} introduces the \McSplit-SI algorithm for the
...
\paragraph*{\ChapterRef{c:universal-graphs}} \hspace{-.8em} introduces exact and heuristic
...
\paragraph*{\ChapterRef{c:conclusion}} \hspace{-.8em} summarises progress made in the dissertation
