...
useful to swap the two graphs given as input to a \McSplit.  We develop two
simple and highly effective rules for determining when to swap the graphs, and
...
the art solvers; this demonstrates that the algorithm runs faster than the
...
The following is a list of the author's publications prior to PhD study.
